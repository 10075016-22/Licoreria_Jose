	...
	if(isset($_POST['submit']) )
	{
		...
		if(!isset($datos))
		{
			$error ='<center><br>
					...
					<br>
					';	
			header("location: listProveedor.php");
		}
		else
		{
			foreach ($datos as $value) 
		{
			$sql=$misqli->query("DELETE FROM proveedor WHERE id_proveedor = ".$value."");
			if($sql)
			{
				$error ='<center><br>
	   ...
	   <div class="mother-grid-inner">
            <!--header start here-->
				...
				<div class="inner-block">
					...
					<?php 
						include 'Conexion.php';
						$sql=$misqli->query("SELECT * FROM proveedor");
					?>
					<table class="table table-hover">
					  ...
					  <tbody id="resultado">
					  	<form method="POST">
						  	...
						  	?>
							    <tr>
							    	<th><input type="checkbox" id="seleccionado" name="eliminar[]" value="<?php echo $row['id_proveedor'] ?>"></th>
