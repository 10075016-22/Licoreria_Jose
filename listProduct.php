...
<?php 
	...
	if(isset($_POST['submit']) )
	{
		...
		{
			$sql=$misqli->query("DELETE FROM producto WHERE id_producto = ".$value."");
			if($sql)
			{
				$error ='<center><br>
	   ...
	   <div class="mother-grid-inner">
            <!--header start here-->
				...
				<div class="inner-block">
					...
					<?php 
						include 'Conexion.php';
						$sql=$misqli->query("SELECT * FROM producto");
					?>
					<table class="table table-hover">
					  ...
					  <tbody id="resultado">
					  	<form method="POST">
						  	...
						  	?>
							    <tr>
							    	<th><input type="checkbox" id="seleccionado" name="eliminar[]" value="<?php echo $row['id_producto'] ?>"></th>
